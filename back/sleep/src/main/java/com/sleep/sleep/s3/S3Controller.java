...
public class S3Controller {
    ...
    @PostMapping("/blob")
    public ResponseEntity<CompletableFuture<byte[]>> findBlobOfS3Object(@RequestHeader("Authorization") String accessToken, @RequestBody Map<String,String> data) throws IOException {
        //byte[] byteArray = s3Service.findBlobOfS3Object(map.get("s3key"));
        CompletableFuture<byte[]> byteArray = s3AsyncService.getObjectBytesAsync(data.get("s3key"));
